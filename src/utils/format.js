...
function getSubject(subjectNumber) {
    ...
    return subjects[position] // como a lista dentro do array começa com valor 0 e não 1, é necessário uma expressão para diminuir sempre 1 do valor selecionado
